	<?php if ( $_REQUEST['mediacat_document_id'] ): ?>
		<div id="setting-error-settings_updated" class="updated settings-error">
			<p><strong>Document date updated successfully.</strong></p>
		</div>
	<?php endif; ?>
	...
	<?php if ( $total_records > 0 ): ?>
		...
		<br>
		<table class="widefat responsive" style="margin-top: 25px">
			<thead>
				<tr>
					<th></th>
							...
							<td width="200">
								...
								<?php else: ?>
									...
									<form action="<?php echo $this->get_mediacat_library_admin_url(); ?>" method="post">
										...
										<input type="submit" value="<?php _e( 'Change Date', self::nspace ); ?>" class="button small" style="margin-top: 5px">
									</form>
								<?php endif; ?>
							</td>
							<?php if ( ! $frontend ): ?>
			...
			<?php else: ?>
				<div class="tablenav-pages pagination-records" style="margin-top: 25px">
					<span class="displaying-num"><?php echo $total_records; ?> <?php _e( 'document(s) found', self::nspace ); ?></span>
					<?php if ( $pagination ): ?>
						<span class="pagination-links">
							<?php echo $pagination; ?>
			...
			<?php endif; ?>
	<?php else: ?>
		<p style="clear:both; margin-top: 25px"><?php _e( 'No results found.', self::nspace ); ?></p>
	<?php endif; ?>
